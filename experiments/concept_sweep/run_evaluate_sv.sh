...
# OUTPUT_BASE_DIR=${HOME}/reft_data/concept_sweep_grid_default/${cfg}/outputs_${ADAPTER}/${POSITIONS}
OUTPUT_BASE_DIR=/mnt/data/byt/reft_data/concept_sweep_grid_larger_vec/${cfg}/outputs_${ADAPTER}/${POSITIONS}
