...
from reft.llm_judge import suppression_prompt_blended_async
...
def generate_steering_prompt(
    ...
    steer_df = suppression_prompt_blended_async(
        client=client,
...
def main(args: Arguments):
    ...
    for concept_id, metarec in metadata.items():
        ...
        save_path = dump_dir / "suppression_prompt_blended.parquet"
